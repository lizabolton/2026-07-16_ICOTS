...
::: {.column .column-image-bg role="img" alt="A trompe-l'oeil painting of a wide-eyed, barefoot boy climbing forward out of a dark picture frame, gripping the edges as if stepping into the real world." style="background-image: url('img/del_caso.jpg'); width: 40%;"}
:::
...
:::{.column width="91%"}
![](img/international students.png)
:::
...
::: {.column .column-image-bg role="img" alt='' style="background-image: url('img/ducks.jpg'); width: 40%;"}
:::
